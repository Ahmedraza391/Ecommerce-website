                ...
                <div class="profile_form">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" value="<?php echo $fetch['user_password'] ?>" name="u_password"  id="password">
                        </div>
                        <div class="form-group">
                    ...
                    <?php
                        if(isset($_POST['update_btn'])){
                            ...
                            $u_query = "UPDATE users SET user_name='$name',user_email='$email',user_password='$password',user_mobile='$mobile' WHERE user_id = $_SESSION[login_user]";
